...
CREATE TABLE `answer` (
  ...
  `an_contents` longtext,
  `an_created_date` datetime NOT NULL,
  `an_modified_date` datetime DEFAULT NULL,
  `an_del` varchar(2) DEFAULT NULL,
  `an_del_date` datetime DEFAULT NULL,
  `an_me_id` varchar(20) NOT NULL,
  `an_qa_id` int NOT NULL,
  PRIMARY KEY (`an_id`),
...
-- Dump completed on 2022-03-17 10:26:15
